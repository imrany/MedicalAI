    ...
    <div class="flex flex-col bg-white justify-center items-center h-[100vh]">
        <div class="flex flex-col justify-center items-center md:w-[350px] max-md:w-[80vw] ">
            ...
            <form class="my-3 flex flex-col w-full" @submit="handleSubmit" @keydown="checkInput" >
                ...
                <input type="password" v-model="password" id="password" name="password" class="mt-2 h-[40px] border-blue-400 border-[1px] bg-white rounded-lg focus:outline-1 focus:outline-blue-500 py-2 px-4 placeholder:text-gray-900" placeholder="Password" required/>
