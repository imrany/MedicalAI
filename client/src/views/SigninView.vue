...
<template>
    <div class="flex flex-col bg-white justify-center items-center h-[100vh]">
        <div class="flex flex-col justify-center items-center md:w-[350px] max-md:w-[80vw] ">
            <p class="text-2xl font-semibold mb-4 text-gray-700">Sign in to <span class="text-gray-600">MedicalAI</span></p>
            <form class="my-3 flex flex-col w-full" @submit="handleSubmit" @keydown="checkInput" >
                ...
                <input type="email" v-model="email" id="email" name="email" class="mt-2 h-[40px] border-gray-600 border-[1px] bg-white rounded-lg focus:outline-1 focus:outline-gray-600 py-2 px-4 placeholder:text-gray-900" placeholder="johndoe@example.com" required/>
                ...
                <input type="password" v-model="password" id="password" name="password" class="mt-2 h-[40px] border-gray-600 border-[1px] bg-white rounded-lg focus:outline-1 focus:outline-gray-600 py-2 px-4 placeholder:text-gray-900" placeholder="Password" required/>
            ...
            <div class="flex justify-between items-center gap-10 mb-10 w-full text-sm max-sm:text-xs">
                <div @click="router.push('/get_verified')" class="text-gray-600 font-semibold  cursor-pointer">Create an account?</div>
                <div  class="text-gray-600 font-semibold cursor-pointer">Forgot password?</div>
            </div>
        </div>
    </div>
</template>
