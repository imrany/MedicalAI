...
const handleSubmit=async(e:any)=>{
    ...
    try {
        ...
        wait.value="cursor-pointer bg-gray-800"
    } catch (error:any) {
        isLoading.value=false
        wait.value="cursor-pointer bg-gray-800"
...
<template>
    <div class="flex flex-col bg-white justify-center items-center h-[100vh]">
        <div class="flex flex-col justify-center items-center md:w-[450px] max-md:w-[80vw]">
            <p class="text-2xl font-semibold mb-1 text-gray-700">Get Started with <span class="text-gray-800">MedicalAI</span></p>
            <form class="my-3 flex flex-col w-full" @submit="handleSubmit">
                ...
                <input type="text" v-model="username" id="username" name="username" class="mt-2 h-[40px] border-gray-500 border-[1px] bg-white rounded-lg focus:outline-1 focus:outline-gray-800 py-2 px-4 placeholder:text-gray-900" placeholder="Username" required/>
                ...
                <input type="password" v-model="password" id="password" name="password" class="mt-2 h-[40px] border-gray-500 border-[1px] bg-white rounded-lg focus:outline-1 focus:outline-gray-800 py-2 px-4 placeholder:text-gray-900" placeholder="Password" required/>
                ...
                <input type="password" v-model="confirm" id="confirm" name="confirm" class="mt-2 h-[40px] border-gray-500 border-[1px] bg-white rounded-lg focus:outline-1 focus:outline-gray-800 py-2 px-4 placeholder:text-gray-900" placeholder="Password" required/>
                <div class="flex justify-between gap-2 max-sm:text-sm">
                    ...
                    <button :class="wait" :disabled="isLoading" class="w-[150px] font-semibold flex my-3 mt-6 justify-center items-center rounded-[50px] h-[40px] max-sm:w-[130px] bg-gray-800 text-white">
                        Sign up
                    </button>
                </div>
            </form>
